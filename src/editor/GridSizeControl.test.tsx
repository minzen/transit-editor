...
describe('GridSizeControl', () => {
  ...
  it('does not update grid size when value is empty', () => {
    const setGridSize = vi.fn()
    render(<GridSizeControl gridSize={40} setGridSize={setGridSize} />)
  ...
  it('does not update grid size when value is 0', () => {
    const setGridSize = vi.fn()
    render(<GridSizeControl gridSize={40} setGridSize={setGridSize} />)
  ...
  it('does not update grid size when value is less than 10', () => {
    const setGridSize = vi.fn()
    render(<GridSizeControl gridSize={40} setGridSize={setGridSize} />)
  ...
  it('does not update grid size when value is greater than 100', () => {
    const setGridSize = vi.fn()
    render(<GridSizeControl gridSize={40} setGridSize={setGridSize} />)
  ...
  it('does not update grid size when value is NaN', () => {
    const setGridSize = vi.fn()
    render(<GridSizeControl gridSize={40} setGridSize={setGridSize} />)
