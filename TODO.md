...
This is the shared backlog and work-in-progress list. Keep entries small enough to finish on one branch. Link an issue or pull request when one exists.
...
No prioritized items are currently recorded.
...
Keep only a short recent history here; Git preserves older completed items.
